...
export default async function HomePage({ params }: HomePageProps) {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center bg-black px-4 py-10 text-center">
      <div className="mx-auto w-full max-w-3xl">
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <p className="max-w-xl text-justify text-md text-muted-foreground">
            <b className="text-gray-400">{t('introHighlight')}</b>{' '}
            {t('introText')}
          </p>
          <p className="max-w-xl text-justify text-md text-muted-foreground">
            {t('mission')}
